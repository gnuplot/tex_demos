...
\tikzset{gp mark 10/.style={mark=triangle,mark options={rotate=180}}}
\tikzset{gp mark 11/.style={mark=triangle*,mark options={rotate=180}}}
...
% TeX document via eg. \tikzset{gp lt plot 1 add}=[fill=black,draw=none] etc.
